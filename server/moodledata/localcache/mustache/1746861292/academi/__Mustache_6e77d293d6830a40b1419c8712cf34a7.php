...
class __Mustache_6e77d293d6830a40b1419c8712cf34a7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                ...
                'element' => array($this, 'block6376250b16012e893e449aaa009e6763'),
            ));
...
';
    ...
    private function section2a510ccf6dc2671a3af5e2a04cd07faf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block6376250b16012e893e449aaa009e6763($context)
    {
        $indent = $buffer = '';
        $value = $context->find('label');
        $buffer .= $this->section2a510ccf6dc2671a3af5e2a04cd07faf($context, $indent, $value);
        $value = $context->find('label');
        if (empty($value)) {
