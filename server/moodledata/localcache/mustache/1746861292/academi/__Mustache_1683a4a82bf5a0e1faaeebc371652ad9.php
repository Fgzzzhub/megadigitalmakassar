...
class __Mustache_1683a4a82bf5a0e1faaeebc371652ad9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4f70aad5aaa3413ec988df9eb14bd1fb($context, $indent, $value);
...
';
        ...
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionA9a81eb694f913c7678d406fa450a44b($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                ';
...
';
        ...
        $buffer .= $this->section9013e1cb65701d78dda268c4ede026ed($context, $indent, $value);
        $buffer .= $indent . '                            ';
...
';
    ...
    private function section4f70aad5aaa3413ec988df9eb14bd1fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawerheadercontent' => array($this, 'block3cdd787739e8cc418f04ecabfa4714f0'),
...
';
    ...
    private function sectionA9a81eb694f913c7678d406fa450a44b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9013e1cb65701d78dda268c4ede026ed(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block3cdd787739e8cc418f04ecabfa4714f0($context)
    {
        $indent = $buffer = '';
