...
class __Mustache_d0068dbf753456942b9646037d2cd960 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section590ee5e168a5c2b21cac89e3223ebc07($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section875bc64e81c04ed986f5bdbdcec37825(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section590ee5e168a5c2b21cac89e3223ebc07(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section875bc64e81c04ed986f5bdbdcec37825($context, $indent, $value);
                $context->pop();
            }
        }
