...
class __Mustache_88a3cf001695d50d5eed722a60aef5e0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/sticky_footer')) {
            $context->pushBlockContext(array(
                ...
                'stickycontent' => array($this, 'blockB98c166720075360a0cec199f268b94c'),
            ));
...
';
    ...
    private function sectionE852e853026be1e2006b8af653a139e2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function blockB98c166720075360a0cec199f268b94c($context)
    {
        $indent = $buffer = '';
...
';
        ...
        $value = $context->find('hasactions');
        $buffer .= $this->sectionE852e853026be1e2006b8af653a139e2($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
