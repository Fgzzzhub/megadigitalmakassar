...
class __Mustache_c8d0dd13b088773a37fa5f766ca31bcc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div data-filterregion="filtermatch" class="hidden hstack gap-2">
';
...
';
        $buffer .= $indent . '    </label>
';
        $buffer .= $indent . '    <select class="form-select" data-filterfield="join" id="core-filter-jointype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '"
';
