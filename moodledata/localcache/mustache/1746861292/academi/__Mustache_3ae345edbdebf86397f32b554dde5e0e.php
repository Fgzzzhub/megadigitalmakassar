...
class __Mustache_3ae345edbdebf86397f32b554dde5e0e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section93cff5e1f907a81d7bae651284bc5c1b($context, $indent, $value);
        $buffer .= $indent . '>
';
        $value = $context->find('hasactionlinks');
        if (empty($value)) {
            ...
            $value = $context->find('modid');
            $buffer .= $this->section7a4b176051b50ab46f6c963f584556aa($context, $indent, $value);
            $value = $context->find('modid');
            if (empty($value)) {
...
';
        ...
        $value = $context->find('hasactionlinks');
        $buffer .= $this->section44184bc8350c62221241cec0558c87d7($context, $indent, $value);
...
';
    ...
    private function section93cff5e1f907a81d7bae651284bc5c1b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7a4b176051b50ab46f6c963f584556aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section44184bc8350c62221241cec0558c87d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
