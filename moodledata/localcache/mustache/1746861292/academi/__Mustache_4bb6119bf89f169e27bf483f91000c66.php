...
class __Mustache_4bb6119bf89f169e27bf483f91000c66 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'blockD258cc48c0b30fd0040d47970ff05789'),
            ));
...
';
    ...
    public function blockD258cc48c0b30fd0040d47970ff05789($context)
    {
        $indent = $buffer = '';
