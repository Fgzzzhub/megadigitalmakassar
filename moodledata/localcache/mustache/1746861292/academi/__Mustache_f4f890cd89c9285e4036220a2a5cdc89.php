...
class __Mustache_f4f890cd89c9285e4036220a2a5cdc89 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                <span
';
        $buffer .= $indent . '                    class="collapsed-icon icon-no-margin me-1"
';
        $buffer .= $indent . '                    title="';
...
';
        $buffer .= $indent . '                <span
';
        $buffer .= $indent . '                    class="expanded-icon icon-no-margin me-1"
';
        $buffer .= $indent . '                    title="';
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section35d5bf61e97a978b841ae2bc811164cd($context, $indent, $value);
        }
        $buffer .= $indent . '    >
';
...
';
        ...
        $buffer .= $this->section25e6fc55f516f2cb497fa2428ade325f($context, $indent, $value);
    ...
    private function section35d5bf61e97a978b841ae2bc811164cd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section25e6fc55f516f2cb497fa2428ade325f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
