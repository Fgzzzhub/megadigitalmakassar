...
class __Mustache_fc602b212977fd896a98797bb6b0b258 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</legend>
';
        $buffer .= $indent . '        <div class="border-radius my-2 p-2 bg-white border d-flex flex-wrap flex-column flex-md-row align-items-md-center gap-2 mx-0">
';
...
';
        ...
        $buffer .= '" class="me-md-2 mb-md-0">';
        $value = $context->find('str');
        $buffer .= $this->section043761c7993201193b2b1d79ec0dd03a($context, $indent, $value);
        $buffer .= '</label>
';
        $buffer .= $indent . '                <select class="form-select" data-filterfield="join" id="core-filter_row-jointype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <label class="visually-hidden pt-2  my-1" for="core-filter_row-filtertype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">';
        $value = $context->find('str');
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '            <select class="form-select" data-filterfield="type" id="core-filter_row-filtertype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div data-filterregion="value" class="d-flex flex-column flex-md-row align-items-md-center gap-2"></div>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <button data-filteraction="remove" class="ms-auto icon-no-margin icon-size-4 btn text-reset" aria-label="';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div data-filterregion="joinadverb" class="ps-1 text-uppercase fw-bold">
';
