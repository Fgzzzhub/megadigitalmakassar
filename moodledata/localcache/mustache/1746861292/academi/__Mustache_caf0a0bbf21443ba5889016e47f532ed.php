...
class __Mustache_caf0a0bbf21443ba5889016e47f532ed extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div
';
        $buffer .= $indent . '    class="dropdown-subpanel position-relative dropend"
';
        $buffer .= $indent . '    id="';
...
';
        $buffer .= $indent . '    </a>
';
        $buffer .= $indent . '    <div class="dropdown-menu dropdown-subpanel-content" role="menu" data-bs-popper="static">
';
        $buffer .= $indent . '        ';
