...
class __Mustache_8a8c92ab5de9ccd5581c37d1ad981fc2 extends Mustache_Template
{
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section1a3e0b34b2191c913f7373a6cd945052($context, $indent, $value);
        }
        $buffer .= $indent . '>
';
...
';
        ...
        $buffer .= $this->sectionB4d0d296583098bc2937f247df66d80d($context, $indent, $value);
    ...
    private function section1a3e0b34b2191c913f7373a6cd945052(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB4d0d296583098bc2937f247df66d80d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
