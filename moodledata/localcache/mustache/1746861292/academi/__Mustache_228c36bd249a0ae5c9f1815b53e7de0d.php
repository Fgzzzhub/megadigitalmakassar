...
class __Mustache_228c36bd249a0ae5c9f1815b53e7de0d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('mod_forum/discussion_list')) {
            $context->pushBlockContext(array(
                ...
                'discussion_list_output' => array($this, 'block1031033ca2a6bc91a0dedb83d412ecf3'),
            ));
...
';
    ...
    private function section6208ce475fc48534bd90e6200dd72acd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
       ...
       ';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('mod_forum/forum_discussion_post')) {
                    $context->pushBlockContext(array(
                        'footer' => array($this, 'block01480e9167e5e9624c8acb220c854bcf'),
...
';
    ...
    public function block01480e9167e5e9624c8acb220c854bcf($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block1031033ca2a6bc91a0dedb83d412ecf3($context)
    {
        $indent = $buffer = '';
        $value = $context->find('posts');
        $buffer .= $this->section6208ce475fc48534bd90e6200dd72acd($context, $indent, $value);
